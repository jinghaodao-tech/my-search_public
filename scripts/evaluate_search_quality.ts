...
fs.writeFileSync(path.join(process.cwd(), 'artifacts', 'ranking-engine-quality.json'), JSON.stringify({ ...qualityArtifact, scope: 'ranking-only' }, null, 2), 'utf-8');
fs.writeFileSync(path.join(process.cwd(), 'artifacts', 'end-to-end-query-quality.json'), JSON.stringify({ ...qualityArtifact, scope: 'end-to-end-query-pipeline' }, null, 2), 'utf-8');
